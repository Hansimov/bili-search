...
class DateFieldConverter:
    ...
    RE_CH_SEP = r"[\_\.\s\-]*"
    RE_THIS_YEAR = rf"(本年|今年|this{RE_CH_SEP}year|ty)"
    RE_LAST_YEAR = rf"(上年|去年|last{RE_CH_SEP}year|ly)"
    RE_PAST_YEAR = rf"(过去一年|past{RE_CH_SEP}year|py)"
    RE_THIS_MONTH = rf"(本月|this{RE_CH_SEP}month|tm)"
    RE_LAST_MONTH = rf"(上个?月|last{RE_CH_SEP}month|lm)"
    RE_PAST_MONTH = rf"(过去一个?月|past{RE_CH_SEP}month|pm)"
    RE_THIS_WEEK = rf"(本周|this{RE_CH_SEP}week|tw)"
    RE_LAST_WEEK = rf"(上周|last{RE_CH_SEP}week|lw)"
    RE_PAST_WEEK = rf"(过去一周|past{RE_CH_SEP}week|pw)"
    RE_THIS_DAY = rf"(本日|今日|今天|this{RE_CH_SEP}day|today|td)"
    RE_LAST_DAY = rf"(上日|昨日|昨天|last{RE_CH_SEP}day|yesterday|ld)"
    RE_PAST_DAY = rf"(过去一天|past{RE_CH_SEP}day|pd)"
    RE_THIS_HOUR = rf"(本时|当前小时|this{RE_CH_SEP}hour|th)"
    RE_LAST_HOUR = rf"(上时|上个小时|last{RE_CH_SEP}hour|lh)"
    RE_PAST_HOUR = rf"(过去一个小时|past{RE_CH_SEP}hour|ph)"
    RE_RANGE_THIS = (
